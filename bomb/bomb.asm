...
0000000000400ee0 <phase_1>: ;answer:Border relations with Canada have never been better.
...
0000000000400efc <phase_2>: ;input:1 2 4 8 16 32
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
...
0000000000400f43 <phase_3>:     ;input two numbers a and b, 2<=a<=7. The pairs are (2,707),(3,256),(4,389),(5,206),6,682),(7,327)
  ...
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax ;this is a trap!!!!!
...
;must input two integers a and b, 0<=a<=0xe(14), where func4(rdx=0xe,rsi=0,a) must set %rax to be 0 using recursion.
;And b must be 0 which is indicated in address 0x401051
;Using a python programm as shown in bomblab_phase4.py, we get 'a' can be 0,1,3,7
;So answers are four pairs (0,0),(1,0),(3,0),(7,0)
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax ;must input two integer a and b
  ...
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) ; b must be 0
...
; input a 6-letter string and each is like a key to a value 
; for example: a->0x61 b->0x64 c->0x75...
; the wanted string is 0x66 0x6c 0x79 0x65 0x72 0x73
; trying a->x, we get the answer:ionufg/ionefg (Maybe there are more answers)
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp
  401067:	48 89 fb             	mov    %rdi,%rbx
  ; inputed string originally stored at %rdi
  ...
  ; input a string the length of which is 6 
  40107f:	83 f8 06             	cmp    $0x6,%eax
  ; %rax:the length of the input
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  ; repeat 6 times to get our input 6 letters which are stored in %rbx
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx
  ; %rcx is a temporary variable that stores the current input letter
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx
  ; 40108f->401099:finds the value that this letter points to and stores it in %rdx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  ; move it to %rsp for following comparing in 4010b8 and 4010bd
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  ; in %rsi, the wanted string:0x66 0x6c 0x79 0x65 0x72 0x73
...
00000000004010f4 <phase_6>: ;input 4 3 2 1 6 5
  ...
  ; read input 6 numbers into %rsp(the same as %r13), %rsi set to 0x0
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401114:	4c 89 ed             	mov    %r13,%rbp
  ; %rsp,%r13,%r14,%rbp all refer to the 6 numbers
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  ; %rax=num1
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  ; num1<=6,else bomb explodes
  ...
  ; from 401132->401151, test whether the 6 numbers are distinct
  ; in other words, the input must be 6 different numbers

  ;%r12d==6,test is over
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi
  401158:	4c 89 f0             	mov    %r14,%rax ;%rax stores our inputs
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx

  ;
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx
  401164:	89 10                	mov    %edx,(%rax) ;%rax=7-num[0]
  401166:	48 83 c0 04          	add    $0x4,%rax ;%rax=num[1]
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  ; from 401160->40116d,num[i]=7-num[i]
  ...
  ;move a list stored in %rdx into %rbp+20 according to the value of our num[0:5]
  ...
  ;from 4011ab->4011d2 relink the list according to the sequence of our input

  ;the declining values of the nodes are: 3 4 5 6 1 2
  ;since the sequence are 7-input
  ;input should be 4 3 2 1 6 5
